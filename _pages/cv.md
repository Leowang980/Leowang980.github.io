...
Email: <a href="mailto:leowang980@outlook.com">leowang980@outlook.com</a><br>
Website: <a href="https://leowang980.github.io/">leowang980.github.io</a>
...
**[1] ICML 2026**<br>
**Lightweight Federated Incremental Learning via Decoupled Replay.**<br>
Xiuying Wang, Yichen Li, Hang Su, Gaozhuo Liu, Shiwei Li, Chuang Zhao, Jiangming Shi, Imran Razzak

**[2] TPAMI**<br>
**Ego-R1: Chain-of-Tool-Thought for Ultra-Long Egocentric Video Reasoning.**<br>
S. Tian, R. Wang, H. Guo, P. Wu, Y. Dong, Xiuying Wang, Jingkang Yang, Hao Zhang, Hongyuan Zhu, Ziwei Liu

**[3] NeurIPS 2025**<br>
**Feature Distillation is the Better Choice for Model-Heterogeneous Federated Learning.**<br>
...
**[4] NeurIPS 2026**<br>
**Rehearsal-Free Statistical Prototype Regularization for Federated Incremental Learning.**<br>
Xiuying Wang, Yichen Li, Jiahua Cheng, Xiwei Liu, Chuang Zhao, Bo Liu, Imran Razzak

**[5] NeurIPS 2026**<br>
**Heterogeneity-aware Distillation for Federated Continual Learning.**<br>
...
*Research Engineer Intern in Chen Change Loy's team | Aug 2025 - Mar 2026 | Singapore*
...
- **PoC for a Smart Glass Company**: Contributed to long-horizon memory construction for egocentric streaming videos captured by always-on smart glasses in everyday scenarios.
...
*Research Engineer Intern in Jingkang Yang's team | May 2026 - Present | Shanghai, China*
...
- **Egocentric Intelligence**: Egocentric video understanding, long-horizon memory, multimodal data collection, and embodied interaction datasets.
- **VLM Systems**: Vision-language models, agentic multimodal systems, RAG, and real-world deployment for interactive AI applications.
- **Federated Learning & Security**: Model-heterogeneous federated learning, privacy-preserving learning, and security analysis.
- **Continual Learning**: Federated continual learning and catastrophic forgetting mitigation.
